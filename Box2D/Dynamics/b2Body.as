...
public class b2Body
{
	...
	*/
	...
	/**
	 * 通过b2Transform数据存储器来设置物体的位置和角度，并且唤醒物体。
	 * Set the position of the body's origin and rotation (radians).
	 * This breaks any contacts and wakes the other bodies.
	...
	*/
	...
	/**
	 * 应用一个力矩
	 * 在没有影响质心线速度的情况下会影响它的角速度。该操作会唤醒物体。
	...
	*/
	...
	/** 
	 * 获取massdata数据，massdata包含物体质量，位置等信息
	...
	*/
	...
	/** 
	 * 激活物体Set the active state of the body. An inactive body is not
